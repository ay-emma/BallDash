...
class _ClubsPageState extends State<ClubsPage> {
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    DropdownButton<String>(
                      value: _chosenVal,
                      underline: Container(),
                      items: <String>["League Names", ...leaguedata ].map<DropdownMenuItem<String>>((String value){
               ...
               Consumer<Db>(
                     ...
                     builder: (context, snap ){
                       ...
                       return  _clubsList(context, snap.data,);
                     }  ),
                      )
            ],
  ...
  Widget _clubsList(context, QuerySnapshot snapshot, ) {
