...
class _MatchFixtureState extends State<MatchFixture> {
 ...
 Widget pointsRowPercent({int homePnt, int awayPnt, String pntName, BuildContext context}) {
  ...
  Widget pointsRow({int homePnt, int awayPnt, String pntName, BuildContext context }) {
    int pointTotal = homePnt + awayPnt;
    double homePercent() {
      if (homePnt / pointTotal > 0) {
        //print("${ homePnt/pointTotal}");
